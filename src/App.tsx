...
function App() {
  ...
  return (
    ...
    >
      ...
      {/* Card with border */}
      <PixelBorder className="w-full max-w-xs sm:max-w-sm bg-white bg-opacity-95 flex flex-col items-center mb-8 p-5 sm:p-8">
        <p
          key={quote}
          className="text-base sm:text-lg text-center mb-8 sm:mb-10 text-black break-words animate-fade-in"
        >
          {quote}
        </p>
        <div className="flex flex-col gap-4 w-full">
          <button
            ...
            className="w-full py-4 bg-blue-500 text-white text-base sm:text-lg rounded-none font-bold border-4 border-black shadow-[4px_4px_0_#222] hover:bg-blue-600 transition"
          ...
          <button
            onClick={handleShare}
            className="w-full py-4 bg-green-500 text-white text-base sm:text-lg rounded-none font-bold border-4 border-black shadow-[4px_4px_0_#222] hover:bg-green-600 transition"
            style={{ fontFamily: "'Press Start 2P', monospace" }}
          >
            📤 Share
          </button>
          <button
            className="w-full py-4 bg-yellow-400 text-black text-base sm:text-lg rounded-none font-bold border-4 border-black shadow-[4px_4px_0_#222] hover:bg-yellow-300 transition"
            style={{ fontFamily: "'Press Start 2P', monospace" }}
          >
            🪙 Mint as NFT
          </button>
